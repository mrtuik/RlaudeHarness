...
class ClaudeRuntimeBridge(
    ...
    override suspend fun respondToQuestion(request: QuestionRequest, answer: String?, skipped: Boolean) = withContext(Dispatchers.IO) {
                ...
                runCatching {
                    ...
                    if (toolName.equals("AskUserQuestion", true) ||
                        ...
                        pending[approvalId] = PendingPermission(
                            ToolRequest(approvalId, sessionId, toolName, text, risk = RiskLevel.LOW),
                            responseFile,
                        )
