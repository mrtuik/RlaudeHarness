...
sealed interface RuntimeEvent {
    ...
    data class QuestionAsked(override val sessionId: String, val request: QuestionRequest) : RuntimeEvent
...
fun stripEmojis(input: String): String {
    ...
    while (i < input.length) {
        ...
        val isEmoji = when {
            ...
            codePoint in 0x02600..0x026FF -> true
            codePoint in 0x02700..0x027BF -> true
            codePoint in 0x02300..0x023FF -> true
            codePoint in 0x02B50..0x02B55 -> true
            codePoint in 0x0200D..0x0200D -> true
            codePoint in 0x0FE0E..0x0FE0F -> true
            codePoint in 0x1F1E6..0x1F1FF -> true
            codePoint in 0x0E0020..0x0E007F -> true
            Character.getType(codePoint) == Character.SURROGATE.toInt() -> true
            Character.getType(codePoint) == Character.OTHER_SYMBOL.toInt() && codePoint > 0x2000 -> true
            else -> false
        }
        if (!isEmoji) {
